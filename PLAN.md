...
| Phase 11: 品質強化・回帰防止 | 完了 | shared case spec、fixture、server / extension ミラー回帰に加え、workbook root family / Codex 作業制御の scripts 監査を固定した | 維持のみ |
...
1. Phase 12 の最小ドキュメント整備として、実装差分に直接関係する文書だけを維持する
2. 既存 parser / AST / LSP 回帰を維持する

...
- 現在の主実装軸は Phase 6 の diagnostics 接続を完了し、補完の文脈絞り込みと型起点の候補精度を強化する段階へ移る
- 直近完了は Phase 6 の diagnostics text fallback を未構造化 `executableStatement` に限定する structured label / statement 接続
